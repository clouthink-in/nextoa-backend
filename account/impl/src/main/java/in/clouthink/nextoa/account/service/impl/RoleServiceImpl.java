...
import in.clouthink.nextoa.account.domain.model.SysRole;
import in.clouthink.nextoa.account.domain.model.User;
import in.clouthink.nextoa.account.domain.model.UserRoleRelationship;
import in.clouthink.nextoa.account.domain.request.RoleQueryRequest;
import in.clouthink.nextoa.account.domain.request.SaveRoleRequest;
import in.clouthink.nextoa.account.domain.request.UserQueryRequest;
import in.clouthink.nextoa.account.exception.UserNotFoundException;
import in.clouthink.nextoa.account.exception.RoleException;
import in.clouthink.nextoa.account.exception.RoleNotFoundException;
import in.clouthink.nextoa.account.repository.AppRoleRepository;
import in.clouthink.nextoa.account.repository.UserRepository;
import in.clouthink.nextoa.account.repository.UserRoleRelationshipRepository;
import in.clouthink.nextoa.account.service.RoleService;
import in.clouthink.nextoa.account.spi.AppRoleReference;
