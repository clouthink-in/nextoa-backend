...
import in.clouthink.nextoa.account.AccountPasswordConfigurationProperties;
import in.clouthink.nextoa.account.domain.model.SysRole;
import in.clouthink.nextoa.account.domain.model.User;
import in.clouthink.nextoa.account.domain.request.AbstractUserRequest;
import in.clouthink.nextoa.account.domain.request.ChangeUserProfileRequest;
import in.clouthink.nextoa.account.domain.request.SaveUserRequest;
import in.clouthink.nextoa.account.domain.request.UserQueryRequest;
import in.clouthink.nextoa.account.exception.UserException;
import in.clouthink.nextoa.account.exception.UserNotFoundException;
import in.clouthink.nextoa.account.exception.UserPasswordException;
...
import in.clouthink.nextoa.shared.DomainConstants;
