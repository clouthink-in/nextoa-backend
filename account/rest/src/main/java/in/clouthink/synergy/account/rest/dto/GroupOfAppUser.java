...
@ApiModel
public class GroupOfAppUser {

	public static void convert(Group group, GroupOfAppUser result) {
	...
	public static GroupOfAppUser from(Group organization) {
		if (organization == null) {
			return null;
		}
		GroupOfAppUser result = new GroupOfAppUser();
