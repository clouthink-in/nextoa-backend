...
public class AttachmentRestController {
     ...
     * @throws IOException
     */
    @PostAuthorize(value = "/attachments/avatar")
    @ResponseBody
    ...
    @PostMapping(value = "/attachments/{id}")
    ...
    @PostMapping(value = "/attachments/{id}/publish")
    ...
    @PostMapping(value = "/attachments/{id}/unpublish")
    ...
    @GetMapping(value = {"/attachments/{id}/download"})
    ...
    @GetMapping(value = "/attachments/{id}/download-history")
