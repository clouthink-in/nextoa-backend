...
public class AttachmentView {
	...
	static void convert(Attachment attachment, AttachmentView result) {
	...
	public static AttachmentView from(Attachment attachment) {
		...
		AttachmentView result = new AttachmentView();
		convert(attachment, result);
		return result;
	}

	public static AttachmentView from(Attachment attachment, boolean downloaded) {
		if (attachment == null) {
			return null;
		}
		AttachmentView result = AttachmentView.from(attachment);
