package in.clouthink.synergy.setting.rest.view;
...
public class SystemSettingView {
	...
	public static void convert(SystemSetting fromObj, SystemSettingView result) {
	...
	public static SystemSettingView from(SystemSetting fromObj) {
		if (fromObj == null) {
			return null;
		}
		SystemSettingView result = new SystemSettingView();
