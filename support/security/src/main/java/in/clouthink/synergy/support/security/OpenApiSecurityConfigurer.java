...
import in.clouthink.synergy.security.impl.spring.UserDetailsServiceImpl;
import in.clouthink.synergy.security.impl.spring.rest.*;
...
public class OpenApiSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    private void configAccess(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .permitAll()
            .antMatchers("/api/shared/**","/api/my/**")
            .hasRole("USER")
            .antMatchers("/api/_devops_/**")
            .hasRole("ADMIN")
            .antMatchers("/api/**")
            //@see RbacWebSecurityExpressionRoot#isPassRbacCheck()
