 ...
 */
@ApiModel
public class ActivityTaskView {

	static void convert(Task task, ActivityTaskView result) {
	...
	public static ActivityTaskView from(Task task) {
		if (task == null) {
			return null;
		}
		ActivityTaskView result = new ActivityTaskView();
		convert(task, result);
		return result;
	}
